...
from Algorithms import GRIA, Maranzana, FI
...
class LowCalManager:
    def __init__(self):
        ...
        print("Distribution type = " + str(self.distType) + "n = " + str(params['blockgroups']))
    ...
    def useEMClusters(self):
        ...
        while cnt<=29:
            ...
            while(j<params['instances']):
                ...
                pm.fi = FI.FastInterchange(params['k'], self.distType)
                i = 1
            ...
            lcost = minCost
            print("time and cost after multiple gmm runss " + str(lcost) + str(ltime))
            pm.fi = FI.FastInterchange(params['k'], self.distType)
            pm.fi.getAllDestinations()
            ...
            finalData.append([medianP, cost, tame, ltime, lcost])
